...
def register_callbacks(app):
    ...
    @app.callback(
        ...
        [Input('tabs', 'value'), Input('municipio-dropdown', 'value')],
        prevent_initial_call=True
    )
    def render_tab_and_update_municipio(tab_name, municipio_id):
        ...
        if tab_name == 'receitas2':
            return receitas2.render_content(municipio_id)
        if tab_name == 'home':
            return home.render_content(municipio_id)
        elif tab_name == 'despesas':
            return despesas.render_content(municipio_id)
    ...
    @app.callback(
        ...
        [State('comparacao-municipios-dropdown', 'value')]
    )
    def update_comparacao(n_clicks, municipios_selecionados):
        ...
        return render_visualizacao(municipios_selecionados)
